...
This is a NodeJS API that supports username and password authentication with JWTs and has APIs that return Qoutes. How awesome is that?
...
It returns a String with a Random quote from quotes. It doesn't require authentication.

#### GET `/api/protected/random-quote`

It returns a String with a Random quote from quotes. It requires authentication. 
